...
pro_gen_score<-ds%>%
                 group_by(gen) %>%
                 get_summary_stats(ind_ce, type= "mean_sd")
...
#statisticized groups' information search was calculated by counting how many of the articles supporting and conflicting with the subsequent group decision were requested by at least one group member.
